...
{{-- ── Infos essentielles ── --}}
<div class="sv-section-label"><i class="fa-solid fa-star text-primary"></i> Infos essentielles</div>
...
<div class="mb-3">
    ...
    <p class="sv-bonus-hint"><i class="fa-solid fa-circle-info me-1"></i>Séparez les éléments par une virgule pour un affichage sous forme de liste.</p>
</div>

{{-- ── Détails ── --}}
<div class="sv-section-label"><i class="fa-solid fa-circle-info text-primary"></i> Détails pratiques</div>
...
<div class="sv-section-label"><i class="fa-solid fa-location-dot text-primary"></i> Localisation</div>
...
{{-- ── Photos ── --}}
<div class="sv-section-label"><i class="fa-regular fa-images text-primary"></i> Photos d'illustration <small class="text-muted">(max 6 · JPEG / PNG / WebP · 4 Mo)</small></div>
